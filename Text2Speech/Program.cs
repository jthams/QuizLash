...
namespace Text2Speech
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            Authentication auth = new Authentication("https://westus.api.cognitive.microsoft.com/sts/v1.0/issueToken", "c0368ee1eccb4554885cff368e2ade8b");
            try
            {
            ...
            using (var client = new HttpClient())
            {
                using (var request = new HttpRequestMessage())
                {
                    ...
                    request.Headers.Add("User-Agent", "Text2Speech");
